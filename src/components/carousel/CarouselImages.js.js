                ...
                <Carousel className={classes.carousel} dynamicHeight infiniteLoop={true} interval={6000} useKeyboardArrows={true} transitionTime={1700} emulateTouch showArrows={false} autoPlay showStatus={false} showThumbs={false} >
                    <div className={classes.image_container} >
                        ...
                        <div className={classes.h1}>
                            <h1 >I'm Soumyadip</h1>
                            <a href="https://drive.google.com/file/d/1lQYKGLqyd_h_Ne2amHMkG9M_2FikEJnt/view?usp=sharing" rel="opener noreferrer" target="_blank">VIEW CV   <FaArrowCircleDown /></a>
                        </div>
                    </div>
                    <div className={classes.image_container}>
                        ...
                        <div className={classes.h2}>
                            ...
                            <h1>THINGS!!</h1>
                            <a href="https://github.com/Samantasoumyadip" rel="opener noreferrer" target="_blank">VIEW PROJECTS   <GoProject /></a>
                        </div>
                    </div>
                    {/* <div className={classes.image_container}>
